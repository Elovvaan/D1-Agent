...
type CommandTab = "home" | "discover" | "search" | "about" | "schools" | "sports" | "games" | "locked-in";
...
const tools: Array<{ label: string; href: string; detail: string; icon: LucideIcon }> = [
  { label: "Operations", href: "/operations", detail: "Main command center", icon: Home },
