...
type SavedProfile = { fullName?: string; sport?: string; primaryPosition?: string; secondaryPosition?: string; jerseyNumber?: string; schoolName?: string; classYear?: number; hometown?: string; bio?: string; avatarUrl?: string; skills?: string[] };
