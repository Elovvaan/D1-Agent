          ...
          <div className="grid gap-6 lg:grid-cols-[260px_1fr]">
            ...
            <div className="min-w-0">
              ...
              <div className="mt-8 rounded-[30px] border border-white/12 bg-white/[0.045] p-5">
                <div className="mb-5"><p className="text-xs font-black uppercase tracking-[0.22em] text-[#F2C200]">{state.code} folder</p><h2 className="mt-1 text-2xl font-black">Schools in {state.name}</h2></div>
